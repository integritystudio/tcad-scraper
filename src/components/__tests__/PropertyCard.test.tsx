...
// Mock CSS modules
vi.mock("../features/PropertySearch/PropertyCard.module.css", () => ({
	default: {
		card: "card",
		header: "header",
		owner: "owner",
...
vi.mock(
	"../features/PropertySearch/PropertyDetails/PropertyDetails.module.css",
	() => ({
		default: {
			container: "container",
		},
...
vi.mock(
	"../features/PropertySearch/components/ExpandButton/ExpandButton.module.css",
	() => ({
		default: {
			button: "button",
			sm: "sm",
...
// Mock section CSS modules
vi.mock(
	"../features/PropertySearch/PropertyDetails/sections/FinancialSection.module.css",
	() => ({
		default: { section: "section", header: "header", content: "content" },
	}),
);

vi.mock(
	"../features/PropertySearch/PropertyDetails/sections/IdentifiersSection.module.css",
	() => ({
		default: { section: "section", header: "header", content: "content" },
	}),
);
...
vi.mock(
	"../features/PropertySearch/PropertyDetails/sections/DescriptionSection.module.css",
	() => ({
		default: { section: "section", header: "header", content: "content" },
	}),
);
...
vi.mock(
	"../features/PropertySearch/PropertyDetails/sections/MetadataSection.module.css",
	() => ({
		default: { section: "section", header: "header", content: "content" },
	}),
);
...
vi.mock(
	"../features/PropertySearch/PropertyDetails/components/SectionHeader.module.css",
	() => ({
		default: { header: "header", icon: "icon", title: "title" },
	}),
);

vi.mock(
	"../features/PropertySearch/PropertyDetails/components/ValueComparison.module.css",
	() => ({
		default: { container: "container", row: "row", label: "label" },
	}),
);

vi.mock(
	"../features/PropertySearch/PropertyDetails/components/FreshnessIndicator.module.css",
	() => ({
		default: { indicator: "indicator", dot: "dot", badge: "badge" },
	}),
);

vi.mock(
	"../features/PropertySearch/PropertyDetails/components/TimestampList.module.css",
	() => ({
		default: { list: "list", item: "item" },
	}),
);

vi.mock(
	"../features/PropertySearch/PropertyDetails/components/TruncatedText.module.css",
	() => ({
		default: { text: "text", button: "button" },
	}),
);
