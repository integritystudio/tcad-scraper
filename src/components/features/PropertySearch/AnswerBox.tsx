...
const SuccessState = ({
  ...
  <>
      ...
      <div className={styles.statisticsGrid}>
        {statistics.avgValue !== undefined && (
          <div className={styles.statCard}>
            ...
            <span className={styles.statValue}>{formatCurrency(statistics.avgValue)}</span>
          </div>
        )}
        ...
        {statistics.totalValue !== undefined && (
          <div className={styles.statCard}>
            ...
            <span className={styles.statValue}>{formatCurrency(statistics.totalValue)}</span>
          </div>
        )}
        ...
        {statistics.topCity && (
          <div className={styles.statCard}>
            ...
            <span className={styles.statValue}>
              {statistics.topCity.name} ({statistics.topCity.count.toLocaleString()})
            </span>
          </div>
        )}
      </div>
    ...
    <div className={styles.answerMeta}>
      ...
      <span className={styles.resultsBadge}>{totalResults.toLocaleString()} results</span>
    </div>
  </>
);
  ...
  <div className={styles.noResultsContent}>
    ...
    <div>
      ...
      <p>
        ...
        Try adjusting your search with common property attributes like address, owner name, or value range.
      </p>
    </div>
  </div>
);
...
export const AnswerBox = ({
  ...
  if (state === 'idle' || (!answer && state !== 'loading' && state !== 'error' && state !== 'no-results')) {
    return null;
  }
