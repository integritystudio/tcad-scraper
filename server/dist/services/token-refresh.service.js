...
exports.tokenRefreshService = exports.TCADTokenRefreshService = void 0;
...
class TCADTokenRefreshService {
    ...
    constructor() {
        ...
        this.currentToken = config_1.config.scraper.tcadApiKey || null;
     ...
     */
    startAutoRefreshInterval(intervalMs = 270000) {
...
exports.TCADTokenRefreshService = TCADTokenRefreshService;
// Export singleton instance
exports.tokenRefreshService = new TCADTokenRefreshService();
// Graceful shutdown
process.on('SIGTERM', async () => {
    logger.info('SIGTERM received, shutting down token refresh service...');
    await exports.tokenRefreshService.cleanup();
});
