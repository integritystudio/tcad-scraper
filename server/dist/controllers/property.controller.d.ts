...
export declare class PropertyController {
     ...
     */
    scrapeProperties(req: Request<{}, {}, ScrapeRequestBody>, res: Response): Promise<Response<any, Record<string, any>>>;
    /**
     * GET /api/properties/jobs/:jobId - Get job status
     */
    getJobStatus(req: Request<{
        jobId: string;
    }>, res: Response, _next: NextFunction): Promise<Response<any, Record<string, any>>>;
    /**
     * GET /api/properties - Get properties from database with filters
     * Cached for 5 minutes per unique filter combination
     */
    getProperties(req: Request<{}, {}, {}, PropertyFilters>, res: Response, _next: NextFunction): Promise<Response<any, Record<string, any>>>;
    /**
     * GET /api/properties/search/test - Test Claude API connection
     */
    testClaudeConnection(_req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
    /**
     * POST /api/properties/search - Natural language search powered by Claude
     */
    naturalLanguageSearch(req: Request<{}, {}, NaturalLanguageSearchBody>, res: Response): Promise<Response<any, Record<string, any>>>;
    /**
     * GET /api/properties/history - Get scrape job history
     */
    getScrapeHistory(req: Request<{}, {}, {}, HistoryQueryParams>, res: Response, _next: NextFunction): Promise<Response<any, Record<string, any>>>;
    /**
     ...
     */
    addMonitoredSearch(req: Request<{}, {}, MonitorRequestBody>, res: Response): Promise<Response<any, Record<string, any>>>;
    /**
     * GET /api/properties/monitor - Get monitored search terms
     */
    getMonitoredSearches(_req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
    /**
