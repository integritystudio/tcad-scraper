...
exports.monitoringConfig = exports.frontendConfig = exports.loggingConfig = exports.claudeConfig = exports.scraperConfig = exports.authConfig = exports.securityConfig = exports.corsConfig = exports.rateLimitConfig = exports.queueConfig = exports.redisConfig = exports.databaseConfig = exports.serverConfig = exports.config = void 0;
 ...
 */
function parseArrayEnv(key, defaultValue) {
    const value = process.env[key];
    if (!value)
        return defaultValue;
...
function validateConfig() {
    ...
    if (exports.config.env.isProduction) {
        if (!exports.config.auth.jwt.secret || exports.config.auth.jwt.secret === 'fallback-secret-change-in-production') {
            errors.push('JWT_SECRET must be set in production');
        }
        if (!exports.config.claude.apiKey) {
...
function logConfigSummary() {
    ...
    logger_1.default.info(`Monitoring: ${exports.config.monitoring.sentry.enabled ? 'Enabled' : 'Disabled'}`);
...
exports.databaseConfig = exports.config.database;
exports.redisConfig = exports.config.redis;
exports.queueConfig = exports.config.queue;
exports.rateLimitConfig = exports.config.rateLimit;
exports.corsConfig = exports.config.cors;
exports.securityConfig = exports.config.security;
exports.authConfig = exports.config.auth;
exports.scraperConfig = exports.config.scraper;
exports.claudeConfig = exports.config.claude;
exports.loggingConfig = exports.config.logging;
exports.frontendConfig = exports.config.frontend;
exports.monitoringConfig = exports.config.monitoring;
// Default export
