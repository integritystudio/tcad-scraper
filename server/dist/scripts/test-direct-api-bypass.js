...
async function testDirectAPIBypass() {
    ...
    try {
        ...
        response.sampleResults?.forEach((result, i) => {
        ...
        const multiPageResults = await page.evaluate(async (token) => {
        ...
        const totalFetched = multiPageResults.reduce((sum, r) => sum + r.count, 0);
...
testDirectAPIBypass();
//# sourceMappingURL=test-direct-api-bypass.js.map