...
async function testTokenRefresh() {
    ...
    console.log('--------------');
    console.log(`Auto-Refresh Enabled: ${config_1.config.scraper.autoRefreshToken}`);
    console.log(`Refresh Interval: ${config_1.config.scraper.tokenRefreshInterval}ms (${config_1.config.scraper.tokenRefreshInterval / 60000} minutes)`);
    console.log(`Cron Schedule: ${config_1.config.scraper.tokenRefreshCron || 'Not set (using interval)'}`);
    console.log('');
    ...
    if (finalHealth.healthy) {
        ...
        console.log(`  2. Refreshes token every ${config_1.config.scraper.tokenRefreshInterval / 60000} minutes`);
