...
export class SearchTermDeduplicator {
	...
	private static readonly TOO_COMMON_TERMS = new Set([
		...
		"Circle",
		"Avenue",
		"Boulevard", // These work but are at the edge
	]);
	...
	private isBusinessSuperset(term: string): boolean {
		...
		const businessSuffixes =
			/^(LLC|Inc|LTD|Ltd|Corp|Company|Partner|Partners|Assoc|Associates|Holding|Holdings|Properties|Property|Real|Develop|Development|Trust|Trusts|Estate|Estates)$/i;
